...
int main(int argc, char **argv)
{
    ...
    Gen3ResourcePackDiagnostics_Destroy(&packDiag);
    CHECK(Gen3ResourcePack_GetEntryCount(pack) == 23069u); /* 4518 + 569 audio leaves + 202 structural + 530 song graphs (R12-B/C/D) + 1057 leaf (R13-B) + 5187 text (R13-C) + 3310 D1 + 2081 battle modules (R13-H2) */
    CHECK(Gen3ResourceCatalog_Count(catalog) == 23069u); /* + 569 audio leaves + 202 structural + 530 song graphs (R12-B/C/D) + 1057 leaf (R13-B) + 5187 text (R13-C) + 3310 D1 + 2081 battle modules (R13-H2) */
    ...
    CHECK(info.entryCount == 23069u); /* + 569 audio leaves + 202 structural + 530 song graphs (R12-B/C/D) + 1057 leaf (R13-B) + 5187 text (R13-C) + 3310 D1 + 2081 battle modules (R13-H2) */
     ...
     * script-family 523 + the remaining families' 32). */
    {
        ...
        CHECK(index != NULL);
        CHECK(EmeraldResourceRangeIndex_GetRangeCount(index) == 5822u);
    }
