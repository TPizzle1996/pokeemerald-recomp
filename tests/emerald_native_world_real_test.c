...
int main(int argc, char **argv)
{
    ...
    Gen3ResourcePackDiagnostics_Destroy(&packDiag);
    CHECK(Gen3ResourcePack_GetEntryCount(pack) == 18521u); /* 4518 + 569 audio leaves + 202 structural + 530 song graphs (R12-B/C/D) + 1057 leaf (R13-B) + 5187 text (R13-C) + 3310 D1 */
    CHECK(Gen3ResourceCatalog_Count(catalog) == 18521u); /* + 569 audio leaves + 202 structural + 530 song graphs (R12-B/C/D) + 1057 leaf (R13-B) + 5187 text (R13-C) + 3310 D1 */
    ...
    CHECK(info.entryCount == 18521u); /* + 569 audio leaves + 202 structural + 530 song graphs (R12-B/C/D) + 1057 leaf (R13-B) + 5187 text (R13-C) + 3310 D1 */
