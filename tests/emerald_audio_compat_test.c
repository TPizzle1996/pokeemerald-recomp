 ...
 * pack (games/emerald/base/emerald-bpee01-v1.rpack, 15373 entries incl. the
...
static void TestAudioCounts(const struct Gen3ResourcePack *pack)
{
    ...
    CHECK("pack total 15373 entries (5819 pre-R13B + 1057 leaf + 5187 text + 3310 D1)",
