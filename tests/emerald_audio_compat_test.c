 ...
 * pack (games/emerald/base/emerald-bpee01-v1.rpack, 15750 entries incl. the
...
static void TestAudioCounts(const struct Gen3ResourcePack *pack)
{
    ...
    CHECK("pack total 15750 entries (R13-D2: +3310 D1 + 377 items)",
          Gen3ResourcePack_GetEntryCount(pack) == 15750u);
