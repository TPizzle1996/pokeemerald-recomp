 ...
 * pack (games/emerald/base/emerald-bpee01-v1.rpack, 17525 entries incl. the
...
static void TestAudioCounts(const struct Gen3ResourcePack *pack)
{
    ...
    CHECK("pack total 17525 entries (R13-E1: +1775 trainers)",
          Gen3ResourcePack_GetEntryCount(pack) == 17525u);
