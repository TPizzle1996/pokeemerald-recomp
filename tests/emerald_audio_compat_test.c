 ...
 * pack (games/emerald/base/emerald-bpee01-v1.rpack, 17735 entries incl. the
...
static void TestAudioCounts(const struct Gen3ResourcePack *pack)
{
    ...
    CHECK("pack total 17735 entries (R13-E2: +210 encounters)",
          Gen3ResourcePack_GetEntryCount(pack) == 17735u);
