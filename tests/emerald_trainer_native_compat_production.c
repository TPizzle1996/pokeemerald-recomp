...
int main(int argc, char **argv)
{
    ...
    CHECK("production pack has 15750 entries (196 trainer + 1608 Pokémon "
          "battle + 288 object-event + 1544 tileset + 882 layout + 771 audio + 530 song graphs + 1057 leaf + 5187 text + 3310 D1 + 377 items)",
          Gen3ResourcePack_GetEntryCount(pack) == 15750u);
    printf("loaded catalog          : %zu resources\n", Gen3ResourceCatalog_Count(catalog));
    CHECK("catalog has 15750 resources (196 trainer + 1608 Pokémon battle + "
          "288 object-event + 1544 tileset + 882 layout + 771 audio + 530 song graphs + 1057 leaf + 5187 text + 3310 D1 + 377 items)",
          Gen3ResourceCatalog_Count(catalog) == 15750u);
    ...
    CHECK("provider entryCount 15750 (196 trainer + 1608 Pokémon + 288 object-event + 1544 tileset + 882 layout + 771 audio + 530 song graphs + 1057 leaf + 5187 text + 3310 D1 + 377 items)",
          info.entryCount == 15750u);
