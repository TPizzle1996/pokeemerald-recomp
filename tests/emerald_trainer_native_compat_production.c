...
int main(int argc, char **argv)
{
    ...
    CHECK("production pack has 17525 entries (196 trainer + 1608 Pokémon "
          "battle + 288 object-event + 1544 tileset + 882 layout + 771 audio + 530 song graphs + 1057 leaf + 5187 text + 3310 D1 + 377 items + 1775 E1)",
          Gen3ResourcePack_GetEntryCount(pack) == 17525u);
    printf("loaded catalog          : %zu resources\n", Gen3ResourceCatalog_Count(catalog));
    CHECK("catalog has 17525 resources (196 trainer + 1608 Pokémon battle + "
          "288 object-event + 1544 tileset + 882 layout + 771 audio + 530 song graphs + 1057 leaf + 5187 text + 3310 D1 + 377 items + 1775 E1)",
          Gen3ResourceCatalog_Count(catalog) == 17525u);
    ...
    CHECK("provider entryCount 17525 (196 trainer + 1608 Pokémon + 288 object-event + 1544 tileset + 882 layout + 771 audio + 530 song graphs + 1057 leaf + 5187 text + 3310 D1 + 377 items + 1775 E1)",
          info.entryCount == 17525u);
