...
int main(int argc, char **argv)
{
    ...
    CHECK(info.entryCount == 27000u); /* + 569 audio leaves + 202 structural + 530 song graphs (R12-B/C/D) + 1057 leaf (R13-B) + 5187 text (R13-C) + 3310 D1 + 2081 battle modules (R13-H2) */
