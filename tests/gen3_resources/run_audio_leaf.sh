...
#        A counts (105/51/388/25 = 569 leaves + 530 song graphs, pack 18580 entries since R13-E3a-2;
...
#          byte-for-byte from the 8 manifests + 8 catalogs (6 pre-R13B
#          families + the R13-B movement/multiboot leaves);
...
if "$root/tools/gen3_resources/pack_build/gen3-pack-build" \
    ...
    pass "pack reproduces byte-for-byte (18580 entries since R13-E3a-2)"
else
