...
/* R9 §7: the Pokémon battle back-sheet / palette trio for this slot moved to
 * the GBA-only TU data/graphics/pokemon_battle_payload.c - the still-front
 * leaf above stays (still table + external back-EGG row, all targets). */
