...
/* R11-C: anim-frame leaves and floor-light palettes are ROM_BASE on native;
 * declared here, defined by the compat seam. */
...
/* R11-C: migrated anim-frame leaves are ROM_BASE on native; declared via emerald/resources/tileset_native.generated.h and defined by the compat seam. */
#if !defined(NATIVE_LINUX)
...
#endif /* !NATIVE_LINUX */
#if !defined(NATIVE_LINUX)
/* R11-C: lava frames 4-7 are parity leaves (unreferenced - the anim table
 * only uses frames 0-3): GBA-only, no canonical, must not link on native. */
...
#if !defined(NATIVE_LINUX)
/* R11-C: Unused1 frames are parity leaves (unreferenced - no anim table
 * uses them): GBA-only, no canonical, must not link on native. */
...
#if !defined(NATIVE_LINUX)
/* R11-C: Unused2 frames are parity leaves (unreferenced - no anim table
 * uses them): GBA-only, no canonical, must not link on native. */
